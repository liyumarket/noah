...
class ActivepropertiesView extends GetView<ActivepropertiesController> {
  const ActivepropertiesView({Key? key}) : super(key: key);
            ...
            children: [
              ...
              Expanded(
                child: controller.properties.isEmpty
                    ...
                    : GetBuilder(
                        builder: (ActivepropertiesController controller) {
